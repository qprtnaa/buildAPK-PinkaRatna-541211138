...
export default function LoginScreen ({navigation}) {
  ...
  return (
    ...
    <CustomImage source= {require ("../assets/Logo.png")} style={styles.logo}/>
        ...
        <Text style={styles.des}>Create a your account!</Text>
        <Text style={styles.email}>Username</Text>
        <Input placeholder="Enter your name"/>
        <Text style={styles.email}>Email</Text>
        <Input placeholder="Enter your email"/>
        <Text style={styles.pw}>Create Password</Text>
        <Input 
          placeholder="Enter Your Password"
          secure="true"
        />

        <ButtonQ title="REGISTER" onPress = {ToPort} color="#CE5A67" mode="secondary"/>

        <Text style={styles.register}>Already have a account? <Text style={{ textSize: 20, color: 'blue', textDecorationLine: 'underline' }} onPress={() => navigation.navigate('Login')}> Sign In</Text> </Text>
